...
@property (atomic, retain) JPFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(JPFMStatement *)statement usingParentDatabase:(FMDatabase*)aDB;
